...
export const VILLES: Ville[] = [
  ...
  },
  {
    ...
    kicker: 'Couture créative · Vienne (86)',
    titreH1: 'Ateliers couture à Fontaine-le-Comte',
    intro:
      "Fontaine-le-Comte est l'une des communes où j'organise le plus volontiers des ateliers couture, que ce soit pour les enfants dès 6 ans, les ados ou les adultes débutants. Située dans la Vienne (86), au cœur du Grand Poitiers, la commune offre un cadre accessible pour apprendre à coudre sans pression, dans une vraie bulle créative. Je propose des cours de couture enfants, des journées créatives adultes, des anniversaires couture et des interventions auprès des écoles, ALSH et médiathèques de Fontaine-le-Comte et des environs. Les habitantes et habitants de Poitiers, Ligugé, Saint-Benoît ou Vouneuil-sous-Biard font facilement le trajet jusqu'ici. Tu as une envie précise — fêter l'anniversaire d'un enfant, monter un atelier entre copines, organiser une animation pour ta structure ? Je m'adapte à ton projet et on définit ensemble le format qui te va.",
  ...
  },
  {
    ...
    kicker: 'Couture créative · Vienne (86)',
    titreH1: 'Ateliers couture à Vouillé',
    intro:
      "À Vouillé, chef-lieu de canton dans la Vienne (86), j'anime régulièrement des ateliers couture pour enfants et pour adultes. Les familles du nord-ouest poitevin — Vouillé, Latillé, Neuville-de-Poitou, Mirebeau — sont souvent à la recherche d'une activité manuelle de qualité, et apprendre à coudre entre dans cette démarche. Mes cours de couture enfants démarrent dès 6 ans, avec des projets concrets pour donner confiance et repartir fier de ce qu'on a cousu soi-même. Côté adultes, je propose des journées créatives dans un cadre convivial, ouvertes aux grandes débutantes. J'organise également des anniversaires couture à Vouillé — un super souvenir pour les 7-12 ans — et des interventions pour les écoles et centres de loisirs du secteur. Contacte-moi avec ton idée, on choisit ensemble le format, le nombre de participants et la date qui t'arrange.",
  ...
  },
  {
    ...
    kicker: 'Couture créative · Vienne (86)',
    titreH1: 'Ateliers couture à Saint-Benoît',
    intro:
      "Saint-Benoît, commune du Grand Poitiers dans la Vienne (86), fait partie des secteurs où j'organise volontiers des ateliers couture, aussi bien pour les enfants dès 6 ans que pour les adultes. Les familles de Saint-Benoît, Poitiers Sud, Ligugé ou Fontaine-le-Comte trouvent ici une vraie occasion de s'initier à la couture dans un cadre chaleureux. Je propose des cours de couture enfants, des journées créatives adultes, des anniversaires couture à Saint-Benoît et des interventions pour les écoles, ALSH, médiathèques et structures associatives du secteur. Que tu cherches une activité manuelle régulière pour ton enfant, un moment créatif entre copines, ou un format pour ton centre de loisirs, on adapte l'atelier à ton public et à tes envies. Contacte-moi avec ton idée : je reviens rapidement vers toi avec une proposition concrète et un format calé sur ta demande.",
  ...
  },
  {
    ...
    statut: 'chef-lieu de canton dans la Vienne',
    kicker: 'Couture créative · Vienne (86)',
    titreH1: 'Ateliers couture à Chauvigny',
    intro:
      "Chauvigny, chef-lieu de canton dans la Vienne (86), côté est poitevin, est l'un des secteurs où j'organise volontiers des ateliers couture pour enfants et pour adultes. J'y propose des cours de couture enfants dès 6 ans, des journées créatives adultes, des anniversaires couture à Chauvigny et des interventions pour les écoles, ALSH, médiathèques et structures associatives. Les familles de Chauvigny, Saint-Julien-l'Ars, Valdivienne ou Poitiers Est y trouvent une activité créative qui change des propositions classiques, dans une ambiance où on apprend en s'amusant. Les ados adorent customiser leurs vêtements, les enfants repartent fiers d'avoir cousu leur propre objet, les adultes débutants reprennent confiance devant la machine à coudre. Tu imagines un projet — atelier de groupe, animation d'anniversaire, stage vacances, intervention pour ta structure ? Raconte-moi, je t'envoie une proposition sur mesure.",
  ...
  },
  {
    ...
    statut: 'sous-préfecture des Deux-Sèvres',
    kicker: 'Couture créative · Deux-Sèvres (79)',
    titreH1: 'Ateliers couture à Bressuire',
    intro:
      "Bressuire, sous-préfecture des Deux-Sèvres (79), au cœur du Bocage bressuirais, est un secteur où je déplace volontiers mes ateliers couture. J'y propose des cours de couture enfants dès 6 ans, des journées créatives adultes, des anniversaires couture à Bressuire et des interventions pour les écoles, ALSH, médiathèques et centres sociaux du bassin bressuirais. Les familles de Bressuire, Cerizay, Mauléon, Nueil-les-Aubiers ou Argentonnay apprécient une activité créative qui vient jusqu'à elles, avec un vrai contenu pédagogique et une ambiance détendue. On apprend à coudre sans stress, on ose la machine à coudre, on repart avec un objet qu'on a fait soi-même. Tu as un projet — anniversaire, moment entre amies, stage vacances, animation pour une structure locale ? Envoie-moi un message, je reviens rapidement avec une proposition adaptée à ton format et à ton public.",
